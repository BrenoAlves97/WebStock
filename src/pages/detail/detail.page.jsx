      ...
      await getDoc(docRef)
        .then((snapshot) => {
          setProduct({
            ...
            created: snapshot.data().createdAt.toDate(),
              ...
              product.images.map((image) => (
                <SwiperSlide key={image.id}>
                  <div
                    ...
                    className="w-full h-[500px] rounded-sm bg-gray-400 relative"
                  >
                  ...
                  <img
                    ...
                    style={{ display: arrImages.includes(image.url) ? 'block' : 'none' }}
                    src={image.url}
                    className="object-scale-down object-center w-full h-[500px] rounded-sm "
                    alt={image.id}
                  />
                </SwiperSlide>
              ))}
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1  sm:grid-cols-2  gap-2 text-gray-50 font-mono font-bold">
              <p className="sm:text-left text-center">
                Preço do produto: {formatedValue.format(product.price)}
              </p>
